...
function Sidebar({
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-(--sidebar-width) p-0 [&>button]:hidden bg-sky-blue z-1000"
  ...
  return (
    <div
      className="group peer hidden md:block z-1000"
    ...
    >
      ...
      >
        <div
          ...
          className="flex h-full w-full flex-col bg-(image:--bg-sky-blue)"
...
const sidebarMenuButtonVariants = cva(cn(
    "peer/menu-button flex w-full items-center overflow-hidden rounded-md p-2 text-left outline-hidden ring-sidebar-ring transition-[width,height,padding] focus-visible:ring-2",
